...
@NonNullApi
public class BubbleProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BubbleProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
